...
namespace OpenFun
{
    public static class Routes
    {
        ...
        static Routes()
        {
            ...
            routes.Add(new NavigationSelection(GAMES_PANGRAM, "Pangram", typeof(OpenFun_Core.Pages.Pangram)));
            routes.Add(new NavigationSelection(GAMES_PANGRAM, "Pangram2", typeof(OpenFun_Core.Pages.Pangram)));
        }
